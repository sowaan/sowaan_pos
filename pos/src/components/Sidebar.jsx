  ...
  return (
    ...
    >
      <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        ...
        {/* navigate on bottom*/}
        <ul className="absolute inset-x-3 bottom-3 space-y-2 font-medium">
          <li>
            <button
              onClick={async () => {
                await logout();
                window.location.pathname = "/pos/signin";
              }}
              className={`flex w-full text-start cursor-pointer items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
